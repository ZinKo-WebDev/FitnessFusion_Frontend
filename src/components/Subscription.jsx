...
import React, {accessToken, useContext, useEffect, useRef, useState } from "react";
import axios from "axios";

const Subscription = () => {
  const navigate = useNavigate();

  const {setUserSubscriptionId, subscriptionPlans, currentUser } = useContext(AuthContext);
